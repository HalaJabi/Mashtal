...
<section>
    ...
    <div class = "product-div">
      <div class = "product-div-left">
        <div class = "img-container">
          <img src = "images/tr15.png" width="400" height="300" alt = "watch">
        </div>

      </div>
      <div class = "product-div-right">
        <h6 class="h6">Trees</h6>
        <h3 class="h3">CYCAD PALM </h3>
        <br>
        ...
        <p class = "product-description">  <b>product-description :</b>
          <br>Queen Sago is a slow growing cycad. It's an evergreen palm, and can attain up to 6meters in height. It's a diecious plant that grows orange cones containing seeds, and precising if it's a male or female tree since the female tree does not grow cones.</p>
  ...
  <table>
    ...
    <tr>
      <th>Flower Color</th>
      <td>Male and Female Cones Form On Separate Plants</td>
