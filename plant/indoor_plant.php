...
<section class="product" id="product">
  ...
  <div class="box-container">
    ...
    <div class="box">
      ...
      <img   src="images/in1.jpg" onmouseover="this.src='images/in2.jpg';" onmouseout="this.src='images/in1.jpg';" alt="">
      <h3>Spider Plant</h3>
    ...
    <div class="box">
      ...
      <img src="images/in3.jpg" onmouseover="this.src='images/in4.jpeg';" onmouseout="this.src='images/in3.jpg';" alt="">
      <h3>Croton Plant</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
    ...
    <div class="box">
      ...
      <img src="images/in5.jpg"onmouseover="this.src='images/in6.jpg';" onmouseout="this.src='images/in5.jpg';" alt="">
      <h3>Umbrella Trees</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
      </div>
    ...
    <div class="box">
      ...
      <img src="images/in20.jpg"onmouseover="this.src='images/in21.jpg';" onmouseout="this.src='images/in20.jpg';" alt="">
      <h3>Natural Plant</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
    ...
    <div class="box">
      ...
      <img src="images/in7.png" onmouseover="this.src='images/in8.jpg';" onmouseout="this.src='images/in7.png';"alt="">
      <h3>Golden Pothos</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
    ...
    <div class="box">
      ...
      <img src="images/in11.jpg" onmouseover="this.src='images/in12.jpg';" onmouseout="this.src='images/in11.jpg';"alt="">
      <h3>Areca Palm</h3>
    ...
    <div class="box">
      ...
      <img src="images/in10.jpeg" onmouseover="this.src='images/in10.jpeg';" onmouseout="this.src='images/in10.jpeg';" width="100"  height="100" alt="">
      <h3>Indoor Gardenia</h3>
