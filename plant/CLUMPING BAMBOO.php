...
<section>
    ...
    <div class = "main-wrapper">
        <?php
        $sql = "SELECT id FROM product where name='CLUMPING BAMBOO' ";
            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "images/bambo5.jpg" width="400" height="300" alt = "watch">
                    </div>

                </div>
                <div class = "product-div-right">
                    <h6 class="h6"> Bamboo Plants</h6>
                    <h3 class="h3"> CLUMPING BAMBOO </h3>
                    <br>
                    <span class = "product-price"> Price : $50.25</span>
                    <br>
                    <input type="hidden" name="hidden_name" value="CLUMPING BAMBOO" />

                    <input type="hidden" name="hidden_price" value="50.25" />

                    <p class = "product-description">  <b>product-description :</b>
                        <br>The Fargesia Rufa has an elegant cascading habit, attractive reddish colored ""stems"". Relatively small in stature, its delicate canes and dense foliage give it a more shrubby appearance than that of many bamboos. The fine texture of this plant makes it excellent for backgrounds and visual screens. Clumps can be pruned to the desired density.</p>
