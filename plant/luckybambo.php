...
<section>
    ...
    <div class = "main-wrapper">
        <?php
        $sql = "SELECT id FROM product where name='LUCKY BAMBOO' ";
            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "images/bambo1.jpg" width="400" height="300" alt = "watch">
                    </div>

                </div>
                <div class = "product-div-right">
                    <h6 class="h6"> Bamboo Plants</h6>
                    <h3 class="h3"> LUCKY BAMBOO </h3>
                    <br>
                    <span class = "product-price"> Price : $8.00</span>
                    <br>
                    <input type="hidden" name="hidden_name" value="LUCKY BAMBOO" />

                    <input type="hidden" name="hidden_price" value="8.000"11 />


                    <p class = "product-description">  <b>product-description :</b>
                        <br>Lucky Bamboo is a plant that is well-known for bringing good luck. Lucky Bamboo is very easy to grow and adds to enhance the décor of your home. The Lucky Bamboo is not a Bamboo plant at all. It grows well in a vase filled with pebbles with just an inch of water above the pebbles. You can add a drop of liquid fertilizer once a week to encourage growth. It can also grow in well aerated potted soil. It needs clean water.The water should be changed once in every two weeks.</p>
...
#hala
        ...
        <tr>
            ...
            <td> Africa, India, China, Taiwan </td>
