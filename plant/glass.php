            ...
            <ul>
                ...
                <li> <b><a href="#Pots&Planters"><img src="images/spider-plant.png" style="width:25px;height:25px;">Pots&Planters    <img src="images/down.png" style="width:10px;height:10px;"></a></b>
                    <ul class ="dropdown">
                        ...
                        <br>
                        <li><a href="glass.html">glass pot </a></li>
                        <br>
...
<section class="product" id="product">
    ...
    <h1 class="heading"> Glass Post  </h1>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <img   src="images/g1.png" onmouseover="this.src='images/g2.png';" onmouseout="this.src='images/g1.png';" alt="">
            <h3>KATJA POT</h3>
        ...
        <div class="box">
            ...
            <img src="images/g4.png"onmouseover="this.src='images/g5.png';" onmouseout="this.src='images/g4.png';" alt="">
            <h3>RIVA</h3>
            <div class="quantity">
                <span> quantity : </span>
                <input type="number" min="1" max="100" value="1">
        ...
        <div class="box">
            ...
            <img src="images/g7.png" onmouseover="this.src='images/g8.png';" onmouseout="this.src='images/g7.png';"alt="">
            <h3>DOODLE YELLOW POT</h3>
        ...
        <div class="box">
            ...
            <img src="images/g9.png" onmouseover="this.src='images/g10.png';" onmouseout="this.src='images/g9.png';"alt="">
            <h3>CHINESE PATTERN POT</h3>
        ...
        <div class="box">
            ...
            <img src="images/g11.png" onmouseover="this.src='images/g12.png';" onmouseout="this.src='images/g11.png';"alt="">
            <h3>BLACK AND WHITE POT</h3>
        ...
        <div class="box">
            ...
            <img src="images/g13.png"onmouseover="this.src='images/g14.png';" onmouseout="this.src='images/g13.png'; "alt="">
            <h3>RUSTIC GOLD OLIVE POT</h3>
