        ...
        <div class = "product-div">
            <div class = "product-div-left">
                <div class = "img-container">
                    <img src = "images/tr4.png" width="400" height="300" alt = "watch">
                </div>

            </div>
            <div class = "product-div-right">
                <h6 class="h6">Trees</h6>
                <h3 class="h3">Pecan Tree </h3>
                <br>
                ...
                <p class = "product-description">  <b>product-description :</b>
                    <br> It is a tall, beautiful tree with attractive compound leaves, a tall straight trunk and furrowed, gray-brown to brown-black bark.</p>
