...
<section>
    ...
    <div class = "product-div">
      <div class = "product-div-left">
        <div class = "img-container">
          <img src = "images/tree1.jpg" width="400" height="300" alt = "watch">
        </div>

      </div>
      <div class = "product-div-right">
        <h6 class="h6">Trees</h6>
        <h3 class="h3">CONOCARPUS
        </h3>
        <br>
        ...
        <p class = "product-description">  <b>product-description :</b>
          <br>Conocarpus is a broadleaf evergreen tree that can withstand drought, salt, heat, and high winds. Its brown bark is flaky and attractive. Throughout the year, flushes of greenish-white and purple flowers are produced but are not showy or noticeable.</p>
  ...
  <table>
    ...
    <tr>
      ...
      <td>S. E. Red Sea Coast and W. Africa</td>
