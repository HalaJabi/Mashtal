    ...
    <div class = "product-div">
      <div class = "product-div-left">
        <div class = "img-container">
          <img src = "images/tr16.png" width="400" height="300" alt = "watch">
        </div>

      </div>
      <div class = "product-div-right">
        <h6 class="h6">Trees</h6>
        <h3 class="h3">ITALIAN CYPRESS</h3>
        <br>
        ...
        <p class = "product-description">  <b>product-description :</b>
          <br>Totem Pole is a narrowly columnar evergreen conifer with dark green foliage could be planted in very narrow places. The shape can add a visual structure to borders or for a striking effect on container plants. It can grow up to 4M tall with only a half meter width. Oil from its leaves has been used in perfumery and folk medicine.</p>
