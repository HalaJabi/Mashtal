    ...
    <div class = "product-div">
      <div class = "product-div-left">
        <div class = "img-container">
          <img src = "images/pa6.png" width="400" height="300" alt = "watch">
        </div>

      </div>
      <div class = "product-div-right">
        <h6 class="h6"> Palms Plants</h6>
        <h3 class="h3">TRAVELLER'S PALM</h3>
        <br>
