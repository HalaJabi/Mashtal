...
<section class="category" id="category">
    ...
    <h1 class="heading"> SEEDS </h1>

    <div class="box-container">

        <div class="box">
            <img src="images/HERB.jpg" alt="">
            <div class="content">
                <h3>Herb Seeds</h3>
                <a href="herbseed.php" class="btn">show now</a>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <a href="vegetableseeds.php" class="btn">show now</a>
            </div>
        </div>

        <div class="box">
            <img src="images/microgreens-outdoors-1024x683.jpg" alt="">
            <div class="content">
                <h3>MicroGreens Seeds</h3>
                <a href="microseeds.php" class="btn">show now</a>
            </div>
        </div>
