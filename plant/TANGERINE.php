...
<section>
    ...
    <div class = "product-div">
      <div class = "product-div-left">
        <div class = "img-container">
          <img src = "images/tr1.png" width="400" height="300" alt = "watch">
        </div>

      </div>
      <div class = "product-div-right">
        <h6 class="h6">Trees</h6>
        <h3 class="h3">TANGERINE </h3>
        <br>
        ...
        <br>Citrus reticulata is commonly called mandarin. It's an orange like fruit, but smaller in size. The orange showy fruit is edible; people likes to eat it whether kids or adults. Tangerine trees have spreading, open crowns covered with glossy, elliptical, fragrant leaves with slightly winged stems and minute teeth along the edges. The flowers are red, white or purple.</p>
  ...
  <table>
    ...
    <tr>
      ...
      <td>Tropical and Subtropical Areas</td>
