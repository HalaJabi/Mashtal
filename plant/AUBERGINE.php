    ...
    <div class = "product-div">
      <div class = "product-div-left">
        <div class = "img-container">
          <img src = "images/tr8.png" width="400" height="300" alt = "watch">
        </div>

      </div>
      <div class = "product-div-right">
        <h6 class="h6">Trees</h6>
        <h3 class="h3">Aubergine </h3>
        <br>
        ...
        <p class = "product-description">  <b>product-description :</b>
          <br>Aubergine or Eggplant is a versatile vegetable that has made its way to every Middle Eastern heart, with a ton of recipes, a beautiful flower, and wonderful fuzzy leaves, it is a must-have plant in your collection. </p>
