...
<section>
    ...
    <div class = "main-wrapper">
        ...
        <?php
        $sql = "SELECT id FROM product where name='River Jasmine' ";
            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "images/CLIMB5.jpg" width="400" height="300" alt = "watch">
                    </div>

                </div>
                <div class = "product-div-right">
                    <h6 class="h6"> CLIMBER</h6>
                    <h3 class="h3"> River Jasmine</h3>
                    <br>
                    <span class = "product-price"> Price : $50.25</span>
                    <br>

                    <input type="hidden" name="hidden_name" value="River Jasmine" />

                    <input type="hidden" name="hidden_price" value="50.25" />

                    <p class = "product-description">  <b>product-description :</b>
                        <br>A perfumed fragrance that tantalizes the senses is one of the many attributes this beautiful plant brings to your garden. The river jasmine is loved for its glossy leaves and fragrant white flowers.
                    </p>
