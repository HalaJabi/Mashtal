...
<section>
    ...
    <div class = "main-wrapper">
        <?php
        $sql = "SELECT id FROM product where name='BAMBOO Plam' ";
            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "images/bambo4.jpg" width="400" height="300" alt = "watch">
                    </div>
                </div>
                <div class = "product-div-right">
                    <h6 class="h6"> Bamboo Plants</h6>
                    <h3 class="h3" name="product_name"> BAMBOO Plam </h3>
                    <br>
                    <span class = "product-price" name="product_price"> Price : $50.25</span>
                    <br>
                    <input type="hidden" name="hidden_name" value="BAMBOO Plam" />

                    <input type="hidden" name="hidden_price" value="50.25" />

                    <p class = "product-description">  <b>product-description :</b>
                        <br>This plant has clusters of small slender canes, and graceful fans with a rich green color.</p>
