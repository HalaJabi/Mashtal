...
<section>
    ...
    <div class = "main-wrapper">
        ...
        <?php
        $sql = "SELECT id FROM product where name='Lace Fern' ";
            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "images/CLIMBER1.jpg" width="400" height="300" alt = "watch">
                    </div>

                </div>
                <div class = "product-div-right">
                    <h6 class="h6"> CLIMBER1</h6>
                    <h3 class="h3"> Lace Fern</h3>
                    <br>
                    <span class = "product-price"> Price : $50.25</span>
                    <br>
                    <input type="hidden" name="hidden_name" value="Lace Fern" />

                    <input type="hidden" name="hidden_price" value="50.25" />


                    <p class = "product-description">  <b>product-description :</b>
                        <br>This delicate lace like fern speaks elegance. It is very easy to care of and loves being in indirect light to shaded areas.

                        Although it is called a fern due to its leafs, it is really a member of the lily family.</p>
