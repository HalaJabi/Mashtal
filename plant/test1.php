    ...
    <div class = "product-div">
      <div class = "product-div-left">
        <div class = "img-container">
          <img src = "images/tr12.png" width="400" height="300" alt = "watch">
        </div>

      </div>
      <div class = "product-div-right">
        <h6 class="h6">Trees</h6>
        <h3 class="h3">SPANISH DAGGER </h3>
        <br>
        ...
        <p class = "product-description">  <b>product-description :</b>
          <br>Yucca gloriosa has flexible, linear blades that rise from a dense, tight rosette. Each blade is armed with a wickedly sharp leaf tip. Tall stalks of ivory white, bell-shaped flowers appear in summer. little care and maintenance are needed to keep it performing well.</p>
