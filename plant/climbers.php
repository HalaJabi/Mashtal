...
<section class="product" id="product">
  ...
  <div class="box-container">
    ...
    <div class="box">
      ...
      <img   src="images/CLIMBER1.jpg" onmouseover="this.src='images/CLIMBER2.jpg';" onmouseout="this.src='images/CLIMBER1.jpg';" alt="">
      <h3>Lace Fern</h3>
      ...
      <a href="LaceFern.php" class="btn"> add to cart</a>
    </div>
    ...
    <div class="box">
      ...
      <img src="images/CLIMBER3.jpg" onmouseover="this.src='images/CLIMBER4.jpg';" onmouseout="this.src='images/CLIMBER3.jpg';" alt="">
      <h3>Common Jasmine</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
      </div>
      <div class="price">$17.00</div>
      <a href="CommonJasmine.php" class="btn">add to cart</a>
    </div>
    ...
    <div class="box">
      ...
      <img src="images/CLIMB5.jpg"onmouseover="this.src='images/CLIMB6.jpg';" onmouseout="this.src='images/CLIMB5.jpg';" alt="">
      <h3>River Jasmine</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
      ...
      <a href="RiverJasmine.php" class="btn">add to cart</a>
    </div>
    ...
    <div class="box">
      ...
      <img src="images/CLIMBER7.jpg" onmouseover="this.src='images/CLIM8.jpg';" onmouseout="this.src='images/CLIMBER7.jpg';"alt="">
      <h3>Grap Ivy</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
      ...
      <a href="CrapIvy.php" class="btn">add to cart</a>
    </div>
    ...
    <div class="box">
      ...
      <a href="EnglishIvy.php" class="btn">add to cart</a>
    </div>
    ...
    <div class="box">
      ...
      <a href="MonsteraAdansonii.php" class="btn">add to cart</a>
    </div>
  </div>
