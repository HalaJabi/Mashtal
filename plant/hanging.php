            ...
            <ul>
                ...
                <li> <b><a href="#Pots&Planters"><img src="images/spider-plant.png" style="width:25px;height:25px;">Pots&Planters    <img src="images/down.png" style="width:10px;height:10px;"></a></b>
                    <ul class ="dropdown">
                        ...
                        <br>
                        <li><a href="hanging.html">hanging pot </a></li>
                        <br>
...
<section class="product" id="product">
    ...
    <h1 class="heading"> Hanging Post  </h1>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <img   src="images/h1.png" onmouseover="this.src='images/h2.png';" onmouseout="this.src='images/h1.png';" alt="">
            <h3>HANGING ROUND POT `KHORSHED`</h3>
        ...
        <div class="box">
            ...
            <img src="images/h5.png" onmouseover="this.src='images/h6.png';" onmouseout="this.src='images/h5.png';"alt="">
            <h3>MIRO</h3>
            <div class="quantity">
                <span> quantity : </span>
                <input type="number" min="1" max="100" value="1">
        ...
        <div class="box">
            ...
            <img src="images/h3.png"onmouseover="this.src='images/h4.png';" onmouseout="this.src='images/h3.png';"  alt="">
            <h3>VINOUS</h3>
            <div class="quantity">
                <span> quantity : </span>
                <input type="number" min="1" max="100" value="1">
