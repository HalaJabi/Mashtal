...
<section>
    ...
    <div class = "product-div">
      <div class = "product-div-left">
        <div class = "img-container">
          <img src = "images/tr18.png" width="400" height="300" alt = "watch">
        </div>

      </div>
      <div class = "product-div-right">
        <h6 class="h6">Trees</h6>
        <h3 class="h3">CAROB TREE</h3>
        <br>
        ...
        <p class = "product-description">  <b>product-description :</b>
          <br>Ceratonia Siliqua is a medium-sized evergreen tree with dense branching and large, glossy, leathery leaves. They are followed by thick, brown, hand-length pods that are highly nutritious, hence the common name, St. John's bread. Carob pods contain about 8% protein, vitamins A and B and about one-third of calories than chocolate.</p>
  ...
  <table>
    ...
    <tr>
      ...
      <td>North Africa, Mediterranean Basin</td>
