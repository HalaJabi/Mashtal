...
<section>
    ...
    <div class = "product-div">
      <div class = "product-div-left">
        <div class = "img-container">
          <img src = "images/tr6.png" width="400" height="300" alt = "watch">
        </div>

      </div>
      <div class = "product-div-right">
        <h6 class="h6">Trees</h6>
        <h3 class="h3">WHITE MULBERRY </h3>
        <br>
        ...
        <p class = "product-description">  <b>product-description :</b>
          <br>The morus alba is a fast growing tree. It has a beautiful round shape. The foliage is dense, and this is one of the reasons why people love this tree. In landscape it gives a nice umbrella shape tree to any garden.</p>
  ...
  <table>
    ...
    <tr>
      ...
      <td>Africa, China, N. and S. America</td>
