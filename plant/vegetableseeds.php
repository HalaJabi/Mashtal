...
<section class="product" id="product">
  ...
  <div class="box-container">
    ...
    <div class="box">
      ...
      <img   src="images/veg2.jpg" onmouseover="this.src='images/veg3.jpg';" onmouseout="this.src='images/veg2.jpg';" alt="">
      <h3>MINI PLUM TOMATOES - HARRAZ</h3>
    ...
    <div class="box">
      ...
      <img src="images/veg4.jpeg" alt="">
      <h3>LETTUCE - HARRAZ</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
      </div>
    ...
    <div class="box">
      ...
      <img src="images/veg1.jpeg" alt="">
      <h3>CORIANDER MICROGREENS - HARRAZ</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
      </div>
