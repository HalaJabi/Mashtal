...
<section class="product" id="product">
  ...
  <h1 class="heading"> MicroGreen Seeds  </h1>
  ...
  <div class="box-container">
    ...
    <div class="box">
      ...
      <img   src="images/micro1.jpeg" alt="">
      <h3>GOURMET GARNISH MICROGREENS - JOHNSONS</h3>
    ...
    <div class="box">
      ...
      <img src="images/micro2.jpeg" alt="">
      <h3>MICROGREENS KIT - HARRAZ</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
      </div>
    ...
    <div class="box">
      ...
      <img src="images/micro3.jpeg" alt="">
