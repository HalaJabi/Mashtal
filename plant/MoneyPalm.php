...
<section>
    ...
    <div class = "main-wrapper">
        <?php
        $sql = "SELECT id FROM product where name='Money PALM' ";
            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "images/palm33.jpg" width="400" height="300" alt = "watch">
                    </div>

                </div>
                <div class = "product-div-right">
                    <h6 class="h6">Plalms Plants</h6>
                    <h3 class="h3"> Money PALM </h3>
                    <br>
                    <span class = "product-price"> Price : $50.25</span>
                    <br>
                    <input type="hidden" name="hidden_name" value="Money PALM" />

                    <input type="hidden" name="hidden_price" value="50.25" />


                    <p class = "product-description">  <b>product-description :</b>
                        <br>This plant is referred to as the Money Tree because it is believed to deliver good luck and fortune to the home in which it is nurtured, it's a low maintenance plant and suitable for indoor decorations

                        The plant is also known as Malabar chestnut or Saba nut, This plant is referred to as the Money Tree because it is believed to deliver good luck and fortune to the home in which it is nurtured.

                        Money tree plants often have their slender trunks braided together and are a low maintenance option for artificially lit areas. Money tree plant care is easy and based upon just a few specific conditions.        </p>
