...
<section>
    ...
    <div class = "main-wrapper">
        ...
        <?php
        $sql = "SELECT id FROM product where name='English lvy' ";
            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "images/CLIM10.jpg" width="400" height="300" alt = "watch">
                    </div>

                </div>
                <div class = "product-div-right">
                    <h6 class="h6"> CLIMBER</h6>
                    <h3 class="h3">English lvy</h3>
                    <br>
                    <span class = "product-price"> Price : $50.25</span>
                    <br>
                    <input type="hidden" name="hidden_name" value="English lvy" />

                    <input type="hidden" name="hidden_price" value="50.25" />

                    <p class = "product-description">  <b>product-description :</b>
                        <br>The english ivy plant has glossy, dark green leaves. Vigorous and easy to grow, English ivy can tolerate full sun to shade, though partial shade is recommended in hot climates, and prefers fertile soil with good drainage. It's one of the plants which are playing a great role in air purifying.
                    </p>
