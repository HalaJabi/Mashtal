...
<section>
    ...
    <div class = "main-wrapper">
        ...
        <?php
        $sql = "SELECT id FROM product where name='Madagaser Palm' ";
            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "images/palm1.jpeg" width="400" height="300" alt = "watch">
                    </div>

                </div>
                <div class = "product-div-right">
                    <h6 class="h6">Plalms Plants</h6>
                    <h3 class="h3"> Madagaser Palm </h3>
                    <br>
                    <span class = "product-price"> Price : $50.25</span>
                    <br>

                    <input type="hidden" name="hidden_name" value="Madagaser Palm" />

                    <input type="hidden" name="hidden_price" value="50.25" />
                    <p class = "product-description">  <b>product-description :</b>
                        <br>This plant has a thick, silvery trunk covered with sharp, needle-like spines. It can start branching after flowering, though this happens rarely. However, the trunk does get thicker as the plant grows.
                    </p>
