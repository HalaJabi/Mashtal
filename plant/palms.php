...
<section class="product" id="product">
  ...
  <div class="box-container">
    ...
    <div class="box">
      ...
      <img   src="images/pa3.png" onmouseover="this.src='images/pa4.png';" onmouseout="this.src='images/pa3.png';" alt="">
      <h3>ORANGE BIRD OF PARADISE</h3>
      ...
      <a href="ORANGEBIRDOFPARADISE.php" class="btn"> add to cart</a>
    </div>
    <div class="box">
      ...
      <img   src="images/pa5.png" onmouseover="this.src='images/pa6.png';" onmouseout="this.src='images/pa5.png';" alt="">
    ...
    <div class="box">
      ...
      <img   src="images/pa7.png" onmouseover="this.src='images/pa8.png';" onmouseout="this.src='images/pa7.png';" alt="">
      <h3>KENTIA PALM</h3>
      ...
      <div class="price">$8.00</div>
      <a href="KENTIAPALM.php" class="btn"> add to cart</a>
    </div>
    ...
    <div class="box">
      ...
      <img   src="images/palm1.jpeg" onmouseover="this.src='images/palm22.jpeg';" onmouseout="this.src='images/palm1.jpeg';" alt="">
      <h3>Madagaser Palm</h3>
      ...
      <div class="price">$8.00</div>
      <a href="Madagascarpalm.php" class="btn"> add to cart</a>
    </div>
    ...
    <div class="box">
      ...
      <img src="images/palm33.jpg" onmouseover="this.src='images/palm4.jpg';" onmouseout="this.src='images/palm33.jpg';" alt="">
      <h3>Money Palm</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
      ...
      <a href="MoneyPalm.php" class="btn">add to cart</a>
    </div>
    ...
    <div class="box">
      ...
      <img src="images/palm5.jpeg"onmouseover="this.src='images/palm6.jpg';" onmouseout="this.src='images/palm5.jpeg';" alt="">
      <h3>Lady Palm</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
      ...
      <a href="LadyPalm.php" class="btn">add to cart</a>
    </div>
