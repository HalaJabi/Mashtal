...
<section>
    ...
    <div class = "main-wrapper">
        <?php
        $sql = "SELECT id FROM product where name='Monstera Adansonii' ";
            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "images/CLIM12.jpg" width="400" height="300" alt = "watch">
                    </div>

                </div>
                <div class = "product-div-right">
                    <h6 class="h6"> CLIMBER</h6>
                    <h3 class="h3">Monstera Adansonii</h3>
                    <br>
                    <span class = "product-price"> Price : $50.25</span>
                    <br>
                    <input type="hidden" name="hidden_name" value="Monstera Adansonii" />

                    <input type="hidden" name="hidden_price" value="50.25" />


                    <p class = "product-description">  <b>product-description :</b>
                        <br>Also known as the Swiss cheese vine, trailing split–leaf or five holes plant, Adanson's Monstera is an evergreen indoor plant that is perfect for smaller spaces. It has a trailing quality that makes it a good pick for hanging baskets or training around a room.
                    </p>
