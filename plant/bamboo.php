...
<section class="product" id="product">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <img   src="images/bambo1.jpg" onmouseover="this.src='images/bambo2.jpeg';" onmouseout="this.src='images/bambo1.jpg';" alt="">
            <h3>Lucky Bamboo </h3>
            ...
            <a href="luckybambo.php" class="btn"> add to cart</a>
        </div>
        ...
        <div class="box">
            ...
            <img src="images/bambo4.jpg" onmouseover="this.src='images/bambo3.jpg';" onmouseout="this.src='images/bambo4.jpg';" alt="">
            <h3>Bamboo Palm</h3>
            <div class="quantity">
                <span> quantity : </span>
                <input type="number" min="1" max="100" value="1">
            ...
            <a href="BambooPalm.php" class="btn">add to cart</a>
        </div>
        ...
        <div class="box">
            ...
            <img src="images/bambo5.jpg"onmouseover="this.src='images/bambo6.jpeg';" onmouseout="this.src='images/bambo5.jpg';" alt="">
            <h3>Clumping Bamboo </h3>
            <div class="quantity">
                <span> quantity : </span>
                <input type="number" min="1" max="100" value="1">
            </div>
            <div class="price">$16.00</div>
            <a href="CLUMPING%20BAMBOO.php" class="btn">add to cart</a>
        </div>
