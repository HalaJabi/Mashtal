        ...
        <div class = "product-div">
            <div class = "product-div-left">
                <div class = "img-container">
                    <img src = "images/pa7.png" width="400" height="300" alt = "watch">
                </div>

            </div>
            <div class = "product-div-right">
                <h6 class="h6">Plalms Plants</h6>
                <h3 class="h3"> KENTIA PALM </h3>
                <br>
...
<br>The Kentia Palm is a majestic palm tree that thrives in tropical climates and is a popular houseplant. Its trunk slowly matures from green to dark brown to complement its slender foliage and make it a lovely sight!
                </p>
