      ...
      <ul>
        ...
        <li> <b><a href="#Pots&Planters"><img src="images/spider-plant.png" style="width:25px;height:25px;">Pots&Planters    <img src="images/down.png" style="width:10px;height:10px;"></a></b>
          <ul class ="dropdown">
            ...
            <br>
            <li><a href="plactic.html">Plastic Post </a></li>
            <br>
...
<section class="product" id="product">
  ...
  <h1 class="heading"> Plastic Post  </h1>
  ...
  <div class="box-container">
    ...
    <div class="box">
      ...
      <img   src="images/p1.png" onmouseover="this.src='images/p2.png';" onmouseout="this.src='images/p1.png';" alt="">
      <h3>RIBBED TROUGH `KHORSHED`</h3>
    ...
    <div class="box">
      ...
      <img src="images/p3.png" onmouseover="this.src='images/p4.png';" onmouseout="this.src='images/p3.png';" alt="">
      <h3>BRICK DESIGN ROUND POT `KHORSHED</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
      </div>
    ...
    <div class="box">
      ...
      <img src="images/p5.png"onmouseover="this.src='images/p6.png';" onmouseout="this.src='images/p5.png';" alt="">
      <h3>GREY CYLINDER POT</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
      </div>
    ...
    <div class="box">
      ...
      <img src="images/p7.png" onmouseover="this.src='images/p8.png';" onmouseout="this.src='images/p7.png';"alt="">
      <h3>SQUARE POT WITH WHEELS</h3>
      <div class="quantity">
        <span> quantity : </span>
        <input type="number" min="1" max="100" value="1">
      </div>
    ...
    <div class="box">
      ...
      <img src="images/p9.png" onmouseover="this.src='images/p10.png';" onmouseout="this.src='images/p9.png';"alt="">
      <h3>LINA</h3>
    ...
    <div class="box">
      ...
      <img src="images/p11.png" onmouseover="this.src='images/p12.png';" onmouseout="this.src='images/p11.png';"alt="">
      <h3>RIVA</h3>
    ...
    <div class="box">
      ...
      <img src="images/p13.png" onmouseover="this.src='images/p14.png';" onmouseout="this.src='images/p13.png';"alt="">
      <h3>MAHOGANY</h3>
    ...
    <div class="box">
      ...
      <img src="images/p15.png"onmouseover="this.src='images/p16.png';" onmouseout="this.src='images/p15.png'; "alt="">
      <h3>JASMIN POT</h3>
