...
<section>
    ...
    <div class = "main-wrapper">
        <?php
        $sql = "SELECT id FROM product where name='Grap lvy' ";
            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "images/CLIMBER7.jpg" width="400" height="300" alt = "watch">
                    </div>

                </div>
                <div class = "product-div-right">
                    <h6 class="h6"> CLIMBER</h6>
                    <h3 class="h3">Grap lvy</h3>
                    <br>
                    <span class = "product-price"> Price : $50.25</span>
                    <br>

                    <input type="hidden" name="hidden_name" value="Grap lvy" />

                    <input type="hidden" name="hidden_price" value="50.25" />

                    <p class = "product-description">  <b>product-description :</b>
                        <br>It's a popular climbing vine because of its beauty and handsome toothed leaves that are glossy and green. The leaves are light bronze-green when young and mature to a deeper green.
                    </p>
