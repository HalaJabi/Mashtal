...
<section class="category" id="category">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <img src="images/BAMBOO.jpeg" alt="">
            <div class="content">
                <h3>Bamboo</h3>
                <a href="bamboo.php" class="btn">show now</a>
            </div>
        </div>

        <div class="box">
            <img src="images/PALMS.jpg" alt="">
            <div class="content">
                <h3>Palm</h3>
                <a href="palms.php" class="btn">show now</a>
            </div>
        </div>

        <div class="box">
            <img src="images/TRESS.jpg" alt="">
            <div class="content">
                <h3>Trees</h3>
                <a href="tress.php" class="btn">show now</a>
            </div>
        </div>
        <div class="box">
            <img src="images/CLIMBERS.jpg" alt="">
            <div class="content">
                <h3>Climbers</h3>
                <a href="climbers.php" class="btn">show now</a>
            </div>
        </div>
        <div class="box">
            ...
            <div class="content">
                <h3>Indoor Plants</h3>
                <a href="indoor_plant.php" class="btn">show now</a>
            </div>
        </div>
