...
<section>
    ...
    <div class = "main-wrapper">
        <?php
        $sql = "SELECT id FROM product where name='Lady PALM' ";
            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "images/palm5.jpeg" width="400" height="300" alt = "watch">
                    </div>

                </div>
                <div class = "product-div-right">
                    <h6 class="h6">Plalms Plants</h6>
                    <h3 class="h3"> Lady PALM </h3>
                    <br>
                    <span class = "product-price"> Price : $50.25</span>
                    <br>
                    <input type="hidden" name="hidden_name" value="Lady PALM" />

                    <input type="hidden" name="hidden_price" value="50.25" />


                    <p class = "product-description">  <b>product-description :</b>
                        <br>Large palm with fans 15 to 30cm wide with 4 to 10 thick shiny leaves. Brown hairy main trunk with thin arching stems. It plays a good role in air purifying.</p>
