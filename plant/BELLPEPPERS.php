    ...
    <div class = "product-div">
      <div class = "product-div-left">
        <div class = "img-container">
          <img src = "images/tr10.png" width="400" height="300" alt = "watch">
        </div>

      </div>
      <div class = "product-div-right">
        <h6 class="h6">Trees</h6>
        <h3 class="h3">Bell peppers </h3>
        <br>
        ...
        <p class = "product-description">  <b>product-description :</b>
          <br>Also known as capsicum, they are full of nutrients that help our blood circulation and vitamin C making them a fantastic addition to your salad!</p>
